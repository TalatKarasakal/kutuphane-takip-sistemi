...
- macOS Universal `.app` 490 MB, DMG 213 MB; `codesign --verify --deep --strict`, Universal mimari, yeni ikon/Plist ve pakette yinelenen `node_modules` bulunmaması doğrulandı.
...
- **SOL-001–SOL-012 — Kapsamlı sorun çözüm paketi**
  ...
  - **Commitler:** `5fab877`, `0a104b1`, `79e3f39`, `409c917`, `f26f768`, `616181e`, `8822f79`, `5be79cc`, `db1e8ce`, `f0c0d9a`, `b1aa2f1`, `fcbf62c`, `65a8f71`, `3654247`.
  - **Doğrulama:** format, typecheck, lint, 23 unit/component testi, 3 Electron E2E, build, audit, PNG/ICNS/ICO ve macOS Universal paket smoke kontrolleri başarılı.
