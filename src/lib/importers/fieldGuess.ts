...
const MEDIA_CANDIDATES: Record<Exclude<MediaMappableField, '__ignore__'>, string[]> = {
  ...
  releaseYear: ['year', 'yıl', 'yil', 'çıkış yılı', 'cikis yili', 'release year', 'releaseyear', 'yapım yılı', 'yapim yili'],
  watchYear: ['watch year', 'watchyear', 'izlenme yılı', 'izlenme yili', 'watched year', 'izledim yılı'],
  ...
  episodeDuration: ['episode duration', 'episodeduration', 'bölüm süresi', 'bolum suresi', 'episode length', 'bölüm dk', 'bolum dk'],
...
const CANDIDATES: Record<Exclude<MappableField, '__ignore__'>, string[]> = {
  ...
  pageCount: ['pages', 'page count', 'pagecount', 'sayfa', 'sayfa sayısı', 'sayfa sayisi', 'sayfa sayisı'],
  genre: ['genre', 'category', 'tür', 'tur', 'kategori', 'tip', 'type'],
  isbn: ['isbn', 'isbn-10', 'isbn-13', 'isbn10', 'isbn13'],
  publicationYear: ['year', 'yıl', 'yil', 'yayın yılı', 'yayin yili', 'basım yılı', 'basim yili', 'publication year', 'publicationyear'],
  ...
  notes: ['notes', 'not', 'notlar', 'yorum', 'yorumlar', 'comment'],
  readStartDate: ['start', 'başlangıç', 'baslangic', 'okumaya başlama', 'okumaya baslama', 'read start', 'readstartdate'],
  readEndDate: ['end', 'bitiş', 'bitis', 'okumayı bitirme', 'okumayi bitirme', 'read end', 'readenddate', 'bitirme'],
};
